...
let kitap2 = {isim:'Hiçbir karşılaşma tesadüf değildir',yazar:'Hakan mengüç',fiyat:36, raf:'2.3.RAF'}
let kitap3 = {isim:'insan neyle yaşar',yazar:'Tolstoy',fiyat:34, raf:'3.4.RAF'}
let kitap4 = {isim:'zafer sızlanarak kazanılmaz',yazar:'Haluk tatar',fiyat:45, raf:'4.1.RAF'}
let kitap5 = {isim:'Şeker portakalı',yazar:'Vasconcelos',fiyat:22, raf:'5.3.RAF'}
